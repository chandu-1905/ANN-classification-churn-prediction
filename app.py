...
#load the pickle files: scalar,encoders
...
#geagraphy data from user input is not prepared or encoded above soo...
...
#concat geography and prepared input data
...
st.write(f"prediction probabilty:{prediction_proba:.3f} " )
